...
<Metrics items={[{ value: "+69%", label: "Agent executions per day", trend: "up" }, { value: "+39%", label: "Distinct users", trend: "up" }, { value: "+38%", label: "Users reaching activation", trend: "up" }]} />
...
The redesign shifted behavior toward the workflows we wanted Ona to support. Measured over the 30 days after full rollout, against the 30 days before it. In the first two weeks alone, **2,810 users across 888 organizations** ran agent executions.

<Metrics items={[{ value: "+69%", label: "Daily executions, 737 → 1,244", trend: "up" }, { value: "+39%", label: "Distinct users, 3,709 → 5,154", trend: "up" }, { value: "+38%", label: "Users activated, 1,384 → 1,907", trend: "up" }]} />

The customers we were most worried about are the ones who moved most. Enterprise executions grew **90%** across the window, and enterprise share of usage rose from 77% to **86%**. Those were the accounts wired into the embedded editor, the ones the risk was actually about. PLG volume held flat over the same period.

## New users found their footing faster

Signups held roughly flat across the window. What changed is how many of them got somewhere. Same traffic arriving, 38% more people reaching a first agent execution inside seven days, which is the part of the funnel the redesign was actually built to move.

A launch bump is easy to mistake for a result, so I kept watching. Usage kept climbing after the measurement window, settled at roughly three times the pre-launch level, and stayed there until the acquisition closed.

<TrendChart
  title="Weekly average daily executions"
  data={[593, 691, 800, 880, 866, 998, 1277, 1298, 1275, 1452, 1793, 2085, 1861, 2682, 3543, 2620, 2583, 2306, 2421, 2296, 2488, 2966, 2633]}
  labels={[{ at: 0, text: "Mar" }, { at: 5, text: "Apr" }, { at: 9, text: "May" }, { at: 13, text: "Jun" }, { at: 18, text: "Jul" }, { at: 22, text: "Aug" }]}
  yTicks={[0, 1000, 2000, 3000]}
  markers={[{ at: 4.14, label: "PLG" }, { at: 5, label: "Full rollout", dashed: true }]}
  caption="Complete weeks only, which smooths the weekday and weekend swing in the daily numbers. Growth later in the period is shared with Automations, which grew from 20.2% of executions to 40.5%."
/>

<Callout info>Anchored to full enterprise rollout 2026-04-06, measured over the 30 days following, against a 30-day pre-launch baseline. External cohort (all non-internal accounts). Launch sequence: PLG 2026-03-31, initial enterprise 2026-04-02, full rollout 2026-04-06. The trend line runs through the final week before the OpenAI acquisition closed.</Callout>
...
**Shipping is where measurement starts.** The launch numbers looked good and would have been easy to stop at. I kept watching them for four months, which is the only reason I know the usage change held rather than spiked. Top of funnel softened later in ways I could not explain from the data I had, and that is the thread I would pull next. The first Session for a new user is a different problem than the tenth for an experienced one, and we designed mostly for the second.
