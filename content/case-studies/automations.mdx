...
<CaseImage src="/images/work/automations/figma-screenshot.png" alt="Exploration screens from the design process" caption="Exploration screens and rapid prototypes from the design process" />
...
<CaseImage src="/images/work/automations/Execution list.png" alt="Execution list showing run statuses at a glance — success, failure, and in-progress" caption="Execution list — run status across all repositories at a glance" />
...
<Slideshow images={[{ src: "/images/work/automations/2.2 [Proposal] Automations_ Breadcrumbs - Execution Details.png", alt: "Execution details showing sampled runs, status, and what needs review", caption: "Execution report — sampled runs surfacing status and what needs review" }, { src: "/images/work/automations/2.3b.1 [Proposal] Automations_ Breadcrumbs - Execution Details.png", alt: "Drilling into a failed execution to understand and continue the work", caption: "Drilling into a failed execution to understand and continue the work" }]} />
...
<Slideshow images={[{ src: "/images/work/automations/2.3b.1 [Proposal] Automations_ Breadcrumbs - Execution Details.png", alt: "Execution details with a failed step highlighted", caption: "Execution details with a failed step highlighted for triage" }, { src: "/images/work/automations/2 - Failure -- full convo.png", alt: "Full conversation log for the failed execution", caption: "Full conversation log — complete trace of what the agent did and where it stopped" }, { src: "/images/work/automations/3 - Failure -- copy actoin id.png", alt: "Copying the action ID to investigate or escalate", caption: "Copying the Action ID to carry the execution context into a new conversation" }, { src: "/images/work/automations/4 - Failure -- convo to look into the issue.png", alt: "Using the action ID in an Ona conversation to investigate the failure", caption: "Entering the Action ID in Ona to step into the exact state where the agent stopped" }]} />
...
<CaseImage src="/images/work/automations/Templates-upgrade-view.png" alt="Template selection alongside existing automations, providing pre-configured starting points" caption="Template library alongside active automations — pre-configured starting points for common workflows" />
