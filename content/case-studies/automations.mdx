...
<Metrics items={[{ value: "36K+", label: "Executions in 5 months", trend: "up" }, { value: "99.7%", label: "Trigger-to-execution reliability" }, { value: "97.5%", label: "Runs completed without intervention" }, { value: "9×", label: "Growth in monthly volume, launch to month 5", trend: "up" }]} />
