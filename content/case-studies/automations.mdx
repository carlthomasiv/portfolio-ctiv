...
<Slideshow images={[{ src: "/images/work/automations/2.3b.1 [Proposal] Automations_ Breadcrumbs - Execution Details.png", alt: "Execution details with a failed step highlighted", caption: "Execution Report: Failed action and its steps" }, { src: "/images/work/automations/2 - Failure -- full convo.png", alt: "Full conversation log for the failed execution", caption: "1. Execution Report: Failed action and it's full conversation" }, { src: "/images/work/automations/3 - Failure -- copy actoin id.png", alt: "Execution Report: Failed action - Copying the action ID", caption: "2. Execution Report: Failed action - Copying the action ID" }, { src: "/images/work/automations/4 - Failure -- convo to look into the issue.png", alt: "3. Conversation: Using the action ID in an Ona conversation to troubleshoot", caption: "3. Conversation: Using the action ID in an Ona conversation to troubleshoot" }]} />
